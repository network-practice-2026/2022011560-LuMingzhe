...
const protocols = [
  ...
  const item = protocolItems.find(item => item.id === protocol.id)
  return {
    ...protocol,
    title: item?.title || protocol.title,
    description: item?.description || protocol.description
  }
})
